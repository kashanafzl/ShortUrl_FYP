  ...
  return (
    <div>
        <div id='about' className='aboutdiv'>
            ...
            <br /><br />
            With built-in analytics, custom link branding, and seamless redirection, we make sharing links effortless and efficient. Start shortening your URLs today and enhance your digital experience!</p>
        </div>
    </div>
  )
}
